...
%
% NOTE: the "hand-coded threshold logic" row/citation below was corrected under C-07
% (see PROGRESS.md) after web-validating each cited paper's full text against the
