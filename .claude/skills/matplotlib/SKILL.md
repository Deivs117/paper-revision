...
metadata:
  ...
  source: https://github.com/K-Dense-AI/scientific-agent-skills/tree/main/skills/matplotlib
  imported: 2026-08-27
---
...
## Note on scripts/references not mirrored here

This import only brought SKILL.md (this project doesn't need the full `scripts/`/`references/`
tree of the upstream repo). If a workflow needs `references/plot_types.md`,
`references/styling_guide.md`, `references/api_reference.md`, or `references/common_issues.md`,
fetch them on demand from
`https://raw.githubusercontent.com/K-Dense-AI/scientific-agent-skills/main/skills/matplotlib/<path>`.
